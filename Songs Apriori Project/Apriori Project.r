...
df_SongsData <- read.csv("C:/Users/Admin/Desktop/Apriori/Bollywood Song List Dataset.csv")
...
write.csv(df_SongList,"C:/Users/Admin/Desktop/Apriori/NewSongList.csv", row.names = TRUE)


txn = read.transactions(file="C:/Users/Admin/Desktop/Apriori/NewSongList.csv", 
